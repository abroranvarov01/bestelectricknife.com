...
const reviews = [
	{
		...
		amazonUrl: "https://amzn.to/3LNz0nS",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/3WLvvkh",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/3Jo0zDL",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/43XbBGK",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/47tUFdh",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/4hKft3G",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/4r5qOQn",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/487WhZx",
	...
	},
	{
		...
		amazonUrl: "https://amzn.to/4nJ80mT",
...
export default function ProductPage() {
	...
	useEffect(() => {
		...
		if (cookies.best === "true") {
			...
			document.cookie =
				"best=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
		}
	}, []);
					...
					<div className="grid md:grid-cols-[400px_1fr] gap-8 mb-12">
						...
						<div className="flex flex-col gap-6">
							...
							<Button size="lg" className="w-full bg-primary hover:bg-primary/90 text-lg" asChild>
								<a href={review.amazonUrl} data-auto>
